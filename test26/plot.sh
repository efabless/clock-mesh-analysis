...
../utils/rawn-plot1.py -g mesh_saveall/*/*tt*1.8.raw -o pdf/tt_ff_clk_static_zoom.pdf $(../utils/get_signals.py $pattern $netlist | ../utils/list_to_args.py) -v -W '0,0.8e-8' -l -s 'v(co_i_0_0)' -s 'v(co_i_1_0)' -s 'v(co_i_2_0)' -s 'v(co_i_3_0)' -s 'v(co_i_4_0)' -s 'v(co_i_5_0)'
../utils/rawn-plot1.py -g mesh_saveall/*/*ss*1.8.raw -o pdf/ss_ff_clk_static_zoom.pdf $(../utils/get_signals.py $pattern $netlist | ../utils/list_to_args.py) -v -W '0,0.8e-8' -l -s 'v(co_i_0_0)' -s 'v(co_i_1_0)' -s 'v(co_i_2_0)' -s 'v(co_i_3_0)' -s 'v(co_i_4_0)' -s 'v(co_i_5_0)'
