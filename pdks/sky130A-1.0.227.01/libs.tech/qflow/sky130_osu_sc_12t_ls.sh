...
set leffile=/ciic/pdks/sky130A/libs.ref/sky130_osu_sc_12t_ls/lef/sky130_osu_sc_12t_ls.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=/ciic/pdks/sky130A/libs.ref/sky130_osu_sc_12t_ls/spice/sky130_osu_sc_12t_ls.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=/ciic/pdks/sky130A/libs.ref/sky130_osu_sc_12t_ls/lib/sky130_osu_sc_12t_ls.lib
...
set techleffile=/ciic/pdks/sky130A/libs.ref/sky130_osu_sc_12t_ls/techlef/sky130_osu_sc_12t_ls.tlef
...
set techfile=/ciic/pdks/sky130A/libs.tech/magic/sky130A.tech	    ;# magic techfile
set magicrc=/ciic/pdks/sky130A/libs.tech/magic/sky130A.magicrc    ;# magic startup script
set magic_display="XR" 	;# magic display, defeat display query and OGL preference
set netgen_setup=/ciic/pdks/sky130A/libs.tech/netgen/sky130A_setup.tcl	;# netgen setup file for LVS
set gdsfile=/ciic/pdks/sky130A/libs.ref/sky130_osu_sc_12t_ls/gds/sky130_osu_sc_12t_ls.gds	;# GDS database of standard cells
set verilogfile=/ciic/pdks/sky130A/libs.ref/sky130_osu_sc_12t_ls/verilog/sky130_osu_sc_12t_ls.v	;# Verilog models of standard cells
